...
public class WeatherFetchr {
    ...
    private static final String API_KEY = "AIzaSyDo53IB7YA_BNBiBL98qA7UMprhaDhuCdw";
    /*
    ...
    public List<GalleryItem> searchPhotos(CheckInPoint location) {
    ...
    private String buildUrl(CheckInPoint location) {
